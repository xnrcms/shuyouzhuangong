...
class ArticleCategory extends Base
{
    ...
    private $mainTable          = 'article_category';
    ...
    private function saveData($parame)
    {
        ...
        $saveData['pid']                = isset($parame['pid']) ? (int)$parame['pid'] : 0;
        $saveData['code']               = isset($parame['code']) ? $parame['code'] : '';
        $saveData['sorts']              = isset($parame['sorts']) ? (int)$parame['sorts'] : 1;
        $saveData['seo_title']          = isset($parame['seo_title']) ? $parame['seo_title'] : '';
        $saveData['seo_keyword']        = isset($parame['seo_keyword']) ? $parame['seo_keyword'] : '';
        $saveData['seo_description']    = isset($parame['seo_description']) ? $parame['seo_description'] : '';
