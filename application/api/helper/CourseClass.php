...
class CourseClass extends Base
{
    ...
    private $mainTable          = 'course_class';
    ...
    private function listData($parame)
    {
    	...
    	if (!empty($data))
        {
            $status        = [lang('text_unknown'),lang('text_enable'),lang('text_prohibit')];
            $types         = [lang('text_unknown'),lang('text_image_text'),lang('text_video'),lang('text_audio')];
            $is_pay        = [lang('text_unknown'),lang('text_pay'),lang('text_free')];
