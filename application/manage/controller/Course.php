...
class Course extends Base
{
    ...
    public function __construct()
    {
        ...
        $this->apiUrl['index']        = 'api/Course/listData';
        $this->apiUrl['edit']         = 'api/Course/detailData';
        $this->apiUrl['add_save']     = 'api/Course/saveData';
        $this->apiUrl['edit_save']    = 'api/Course/saveData';
        $this->apiUrl['quickedit']    = 'api/Course/quickEditData';
        $this->apiUrl['del']          = 'api/Course/delData';
        $this->apiUrl['category']     = 'api/CourseCategory/listData';
    }
	...
	public function index()
    {
        ...
        //初始化模板
        $listNode   = $this->tpl->showListTpl($this->getTplData('','课程管理列表','list'));
        ...
        //页面头信息设置
        $pageData['isback']             = 0;
        $pageData['title1']             = '课程管理';
        $pageData['title2']             = '对课程进行添加、编辑、删除等操作';
        $pageData['notice']             = [
	...
	public function add()
    {
        ...
        $formNode   = $this->tpl->showFormTpl($this->getTplData('addedit','新增/编辑课程表单','form'),0);
	...
	public function edit($id = 0)
    {
        ...
        //初始化表单模板 默认当前路由为唯一标识，自己可以自定义标识
        $formNode   = $this->tpl->showFormTpl($this->getTplData('addedit','新增/编辑课程表单','form'),1);
        $formId     = isset($formNode['info']['id']) ? intval($formNode['info']['id']) : 0;
        $formTag    = isset($formNode['tags']) ? $formNode['tags'] : '';
        $formList   = isset($formNode['list']) ? $formNode['list'] : [];
