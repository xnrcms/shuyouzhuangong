...
class Profession extends Base
{
    ...
    public function __construct()
    {
        ...
        $this->apiUrl['index']        = 'api/Profession/listData';
        $this->apiUrl['edit']         = 'api/Profession/detailData';
        $this->apiUrl['add_save']     = 'api/Profession/saveData';
        $this->apiUrl['edit_save']    = 'api/Profession/saveData';
        $this->apiUrl['quickedit']    = 'api/Profession/quickEditData';
        $this->apiUrl['del']          = 'api/Profession/delData';
    }
	...
	public function index()
    {
        ...
        //初始化模板
        $listNode   = $this->tpl->showListTpl($this->getTplData('','课程职业列表','list'));
        ...
        //页面头信息设置
        $pageData['isback']             = 0;
        $pageData['title1']             = '职业管理';
        $pageData['title2']             = '对职业进行添加、编辑、删除等操作';
        $pageData['notice']             = ['职业列表只是展示部分字段信息，详情请点击编辑查看.'];
	...
	public function add()
    {
        ...
        $formNode   = $this->tpl->showFormTpl($this->getTplData('addedit','新增/编辑课程职业表单','form'),0);
	...
	public function edit($id = 0)
    {
        ...
        //初始化表单模板 默认当前路由为唯一标识，自己可以自定义标识
        $formNode   = $this->tpl->showFormTpl($this->getTplData('addedit','新增/编辑课程职业表单','form'),1);
        $formId     = isset($formNode['info']['id']) ? intval($formNode['info']['id']) : 0;
        $formTag    = isset($formNode['tags']) ? $formNode['tags'] : '';
        $formList   = isset($formNode['list']) ? $formNode['list'] : [];
